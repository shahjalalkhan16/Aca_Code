...
time = 90; // in minutes
calls = 10; // number of calls in 90 minutes

// Solution
CR = calls / (time / 60); // call arrival rate in calls per hour
tavg = (60 + 74 + 80 + 90 + 92 + 70 + 96 + 48 + 64 + 126) / 10; // average call holding time in seconds per call
